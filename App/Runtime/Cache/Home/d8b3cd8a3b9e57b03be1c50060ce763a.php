...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="change-regis-header">
                <form action="" method="POST" type="multipart/form-data"></form>
                <!--<span class="btn-change-regis" onclick="changeface()">更换头像</span>-->
                <input type="file" class="btn-change-regis" onclick="changeface()" value="更换头像"></input>
 ...
 <form enctype="multipart/form-data" action="/index.php/Home/Test/upavatar" target="ifram_sign" method="POST">
        <input name="submit" id="submit" value="" type="hidden">
        <label>上传文件: <input name="avatar" type="file" id="test_file" size="48"></label>
