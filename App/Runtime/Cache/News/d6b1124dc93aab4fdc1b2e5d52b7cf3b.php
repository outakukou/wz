    ...
    <div class="container-blue">
        ...
        <div class="mod-bidding">
            <div class="hd-bidding">
                <a class="link-new-bidding" href="/index.php/News/Information/picdesc">添加项目</a>
            </div>
        ...
        <ul class="l-list pt0">
            ...
            <li class="li-list">
                <div class="mode-li-list">
                    ...
                    <span class="more-li-list"><a class="link-li-list" href="/index.php/News/Information/detail?id=<?php echo $v['id'];?>">（了解更多）</a></span>
                </div>
                <div class="mod-sub-article ptb2">
                    <span class="time-sub-article"><?php echo addymd($v['addtime']);?></span>
                    <a href="javascript:void(0);" class="dianzan" idd="<?php echo $v['id'];?>"> 
                    <span class="praise-sub-article"><img src="/Public/static/images/icon-sub-company_06.png" alt=""/><span><?php echo $v['click_good'];?></span></span>
                    </a>
...
(function(){  
    $(".dianzan").click(function(){
      ...
      var self=$(this);
            ...
            $.ajax({
            type:"POST",
            url:"/index.php/News/Information/ajaxZan?id="+id,
    ...
    $.ajax({
    type : "get",
    url : "/index.php/News/Information/lst",
    dataType : "jsonp",
    jsonp: "callback",
