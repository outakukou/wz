...
<body>
    <div class="container-blue">
        <form action="/index.php/Feedback/Feedback/add" method="POST">
        <ul class="l-create-wz">
            <li class="li-create-wz">
                <label class="label-create-wz">主&nbsp;&nbsp;题</label>
                <input class="itxt-create-wz" type="text" value="" name="title"/>
            </li>
            <li class="li-create-wz">
                <label class="label-create-wz">您的反馈</label>
                <textarea class="txtarea-create-wz" name="contents" id="" cols="30" rows="5"></textarea>
            </li>
            <li class="submit-create-wz">
                <!--<span class="btn-preview-create"><a href="javascript:void(0);">取&nbsp;&nbsp;消</a></span>-->
               <input class="btn-preview-create" type="reset" value="取&nbsp;&nbsp;消"/>
                <input class="btn-submit-create" type="submit" value="提&nbsp;&nbsp;交" />
            </li>
        </ul>
            </form>
    </div>
    ...
    <div class="box-tools-wz">
        <ul class="l-set-tools none">
            ...
            <li class="li-set-tools logout" >
                ...
                <a href="/index.php/Feedback/Login/logout"><span class="text-li-tools">退出账户</span></a>
            </li>
        </ul>
        <div class="clear"></div>
        <ul class="l-tools-wz">
