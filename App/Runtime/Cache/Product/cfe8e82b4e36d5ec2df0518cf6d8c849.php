...
<body>
    ...
    <div class="container-blue">
        <div class="none" the-role="text" the-id="toggleBox">
            <form action="/index.php/Product/Product/add" method="post"  enctype="multipart/form-data">
                <ul class="l-create-normal">
                    <li class="li-create-normal js-type-create">
                        ...
                        <div class="type-create-normal">
                            <span the-id="typeTxt"><?php echo $data['type'];?></span>
                            <span class="arrow"><img src="/Public/static/images/arrow-type_03.png" alt=""/></span>
                            <input the-id="hiddenType" name="type" type="hidden" value="图文" />
                        </div>
                    </li>
                    <li class="li-create-normal">
                        <label class="label-create-normal" for="">产品名称</label>
                        <input class="itxt-create-normal" type="text" value="<?php echo $data['title'];?>" name="title"/>
                    </li>
                        ...
                        <li class="li-create-normal">
                            <div class="mod-content-create">
                                <div class="box-content-create">
                                    ...
                                    <input class="hidden-file-box" type="file" name="mpic" />
                                    <?php echo IMG_URL . $data['lstpic'];?>
                                </div>
                                <div class="box-textarea-file">
                                    <textarea class="textarea-file-box" name="content" id="" cols="30" rows="4"><?php echo $data['content'];?></textarea>
                                </div>
                            </div>
                            <?php echo IMG_URL . $data['lstpic'];?>
                            <!--
                            <div class="group-btn-file">
                                ...
                                <span the-id="addBtn" class="btn-file">继续添加</span>
                            </div>
                            -->
                        </li>
                        <li the-id="toAdd" class="li-create-normal none">
                            <div class="mod-content-create">
                                <span class="poster-create-img"><img src="/Public/static/images/img-add_03.jpg" alt=""/></span>
                                <p class="text-create-img">产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍产品介绍</p>
                            </div>
                            <div class="group-btn-file">
                                <span class="btn-file">置&nbsp;&nbsp;顶</span>
                                <span class="btn-file">删&nbsp;&nbsp;除</span>
        ...
        <div the-role="link" the-id="toggleBox" class="none">
            <form action="/index.php/Product/Product/add" method="post">
            <ul class="l-create-normal">
                <li class="li-create-normal js-type-create">
                    <label class="label-create-normal" for="">栏目类型</label>
                    <div class="type-create-normal">
                        <span the-id="typeTxt">链接</span>
                        <span class="arrow"><img src="/Public/static/images/arrow-type_03.png" alt=""/></span>
                        <input the-id="hiddenType" name="type" type="hidden" value="链接" />
                    </div>
                </li>
                <li class="li-create-normal">
                    <label class="label-create-normal" for="">产品名称</label>
                ...
                <li class="li-create-normal">
                    <label class="label-create-normal" for="">链接</label>
                    <input class="itxt-create-normal" type="text" name="link" placeholder="这里输入链接地址" autofocus/>
                </li>
                <li class="submit-create-normal">
                    <span class="btn-preview-create">预&nbsp;&nbsp;览</span>
                    <input class="submit-preview-create" type="submit" value="发&nbsp;&nbsp;布" />
