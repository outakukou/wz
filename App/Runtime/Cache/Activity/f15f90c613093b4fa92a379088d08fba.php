...
<div class="container-blue">
    ...
    <ul class="l-list pt0">
        <li class="li-list">
            <div class="mode-li-list">
                <span class="poster-li-list"><img src="/Public/static/images/poster-li-list_03.jpg" alt=""/></span>
                <h3 class="title-li-list"><span class="fwb">标题：</span>六一微站</h3>
                <p class="text-li-list"><span class="fwb">内容：</span>销售精英的必选神器！<br/>移动互联网时代来临时，我们</p>
                <span class="more-li-list"><a class="link-li-list" href="detail-product.html">（了解更多）</a></span>
            </div>
    ...
    -->
    <a class="link-new-bidding" href="/weizhan/create.html">添加项目</a>
    <div class="mod-bidding">
        <!--
        <div class="hd-bidding">
        </div>
        -->
        <div class="bd-bidding">
            <ul class="l-list">
                <li class="li-list">
                    <div class="mod-li-list">
                        <span class="poster-li-list"><img src="/Public/static/images/poster-active_03.jpg" alt=""/></span>
                        <h3 class="title-li-list"><span class="fwb">标题：</span>活动一</h3>
                        <p class="text-li-list"><span class="fwb">内容：</span>北京奥伦达圣诞宴会，届时将邀请诸多明星共享欢乐时刻届时将邀请诸多明星共享欢乐时刻届时将邀请诸多明星共享欢乐时刻</p>
                        <span class="more-li-list"><a class="link-li-list" href="detail-active.html">（了解更多）</a></span>
                    </div>
                    <div class="mod-sub-article ptb2">
                        <span class="time-sub-article">2015年2月10日</span>
                        <span class="praise-sub-article"><img src="/Public/static/images/icon-sub-company_06.png" alt=""/>2000</span>
                    ...
                    <p class="tip-count-message plr_p4">您有25条留言信息</p>
                    <ul class="l-btn-message plr_p4">
                        <li class="li-btn-message ml0">删&nbsp;&nbsp;除</li>
                        <li class="li-btn-message">置&nbsp;&nbsp;顶</li>
                        <li class="li-btn-message">修&nbsp;&nbsp;改</li>
                        <li class="li-btn-message resume-btn-message mr0"><a class="link-btn-message" href="/weizhan/news-m-detail.html">查看留言</a></li>
                    </ul>
                </li>
                <li class="li-list">
                    <div class="mod-li-list">
                ...
                <li class="li-list">
                    <div class="mod-li-list">
                        <span class="poster-li-list"><img src="/Public/static/images/poster-active_03.jpg" alt=""/></span>
                        <h3 class="title-li-list"><span class="fwb">标题：</span>活动一活动一活动一活动一活动一活动一活动一活动一活动一</h3>
                        <p class="text-li-list"><span class="fwb">内容：</span>北京奥伦达圣诞宴会，届时将邀请诸多明星共享欢乐时刻届时将邀请诸多明星共享欢乐时刻届时将邀请诸多明星共享欢乐时刻</p>
                        <span class="more-li-list"><a class="link-li-list" href="detail-active.html">（了解更多）</a></span>
                    </div>
                    <div class="mod-sub-article ptb2">
