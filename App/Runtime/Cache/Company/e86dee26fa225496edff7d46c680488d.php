...
<div class="container-blue">
    <span class="btn-reedit-company"><a href="/index.php/Company/Company/picdesc">重新编辑</a></span>
    ...
    <form action="/index.php/Company/Company/reedit2" method="post">
...
<!--    <div class="poster-article-wz"><img src="/Public/static/images/poster-company_03.jpg" alt=""/></div>
    ...
    <div class="bd-article-wz">
        ...
        <p class="text-bd-wz">
            ...
            <textarea id="contents" name="contents" placeholder="这里输入内容" autofocus><?php echo $data['contents'];?></textarea>
           <!--<textarea id="editor" name="contents" placeholder="这里输入内容" autofocus><?php echo $data['contents'];?></textarea>-->
           </p>
    </div>
